...
<body class="gray-bg">
    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
            <div>
                <img alt="image" style="width: 300px;" src="<?php echo base_url() ?>assets/images/eCampuz-icon.png" />
            </div>
            <h3>Welcome to eCampuz</h3>
            ...
            <p>For Test eCampuz</p>
            <p>*Username : admin | *Password : aaa</p>
        </div>
    </div>
